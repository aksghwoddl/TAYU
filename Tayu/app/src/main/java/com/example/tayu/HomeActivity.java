...
public class HomeActivity extends AppCompatActivity
    ...
    Fragment7 fragment7;
    String start2;
    Double startX,startY=null;
    String end2;
    Double endX,endY=null;
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            @Override public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()){
                  ...
                  // case R.id.tab5:{ getSupportFragmentManager().beginTransaction() .replace(R.id.main_layout,fragment6).commitAllowingStateLoss(); return true; }
                    //case R.id.tab5:{ getSupportFragmentManager().beginTransaction() .replace(R.id.main_layout,fragment7).commitAllowingStateLoss(); return true; }
