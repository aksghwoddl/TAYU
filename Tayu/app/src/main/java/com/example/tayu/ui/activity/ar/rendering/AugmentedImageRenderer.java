 ...
 */
package com.example.tayu.ui.activity.ar.rendering;
...
public class AugmentedImageRenderer {
  ...
  public void createOnGlThread(Context context) throws IOException {
    ...
    imageFrameUpperLeft.setMaterialProperties(0.0f, 10.0f, 10.0f, 10.0f);
  ...
  public void createOnGlThread1(Context context) throws IOException {

    imageFrameUpperLeft.createOnGlThread(
            context, "models/anchor.obj", "models/anchor.png");
    imageFrameUpperLeft.setMaterialProperties(0.0f, 4.0f, 4.0f, 6.0f);
    imageFrameUpperLeft.setBlendMode(ObjectRenderer.BlendMode.SourceAlpha);
  ...
  public void draw(
    ...
    Pose[] localBoundaryPoses = {
      Pose.makeTranslation(
          0.16f * augmentedImage.getExtentX(),
          0.0f,
          0.16f * augmentedImage.getExtentZ()), // upper left
      Pose.makeTranslation(
