...
package com.example.tayu.ui.activity.ar;
...
import com.example.tayu.ui.activity.ar.rendering.AugmentedImageRenderer;
        ...
        case PAUSED:
          ...
          if(augmentedImage.getIndex()==0){
            ...
            try {
              // Create the texture and pass it to ARCore session to be filled during update().
              augmentedImageRenderer.createOnGlThread(/*context=*/ this);
              // augmentedImageRenderer.createOnGlThread2(this);
            } catch (IOException e) {
              Log.e(TAG, "Failed to read an asset file", e);
            }
            ...
            try {
              // Create the texture and pass it to ARCore session to be filled during update().
              augmentedImageRenderer.createOnGlThread1(/*context=*/ this);
              // augmentedImageRenderer.createOnGlThread2(this);
            } catch (IOException e) {
              Log.e(TAG, "Failed to read an asset file", e);
            }
